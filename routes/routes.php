...
class routes
{
    ...
    {
        $route = self::create('GET','show','homepage','homepageController','show');
        $routes[] = $route;
        $route = self::create('POST','create','homepage','homepageController','create');
        $routes[] = $route;
        $route = self::create('GET','show','tasks','tasksController','show');
        $routes[] = $route;
        $route = self::create('GET','all','tasks','tasksController','all');
        $routes[] = $route;
        $route = self::create('GET','all','accounts','accountsController','all');
        $routes[] = $route;
        $route = self::create('GET','show','accounts','accountsController','show');
        $routes[] = $route;
        $route = self::create('POST','login','accounts','accountsController','login');
        $routes[] = $route;
        $route = self::create('POST','delete','tasks','tasksController','delete');
        $routes[] = $route;
        $route = self::create('POST','delete','accounts','accountsController','delete');
        $routes[] = $route;
        $route = self::create('GET','edit','accounts','accountsController','edit');
        $routes[] = $route;
        $route = self::create('POST','save','accounts','accountsController','save');
        $routes[] = $route;
        $route = self::create('GET','register','accounts','accountsController','register');
        $routes[] = $route;
        $route = self::create('POST','register','accounts','accountsController','store');
        $routes[] = $route;
        $route = self::create('GET','showTasks','tasks','tasksController','showTasks');
        $routes[] = $route;
        $route = self::create('POST','edit','tasks','tasksController','edit');
        $routes[] = $route;
        $route = self::create('POST','save','tasks','tasksController','save');
        $routes[] = $route;
        $route = self::create('POST','create','tasks','tasksController','create');
        $routes[] = $route;
